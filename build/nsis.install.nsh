...
!define HELPURL "https://github.com/ptonchain/go-ptonchain/issues"
!define UPDATEURL "https://github.com/ptonchain/go-ptonchain/releases"
!define ABOUTURL "https://github.com/ptonchain/go-ptonchain#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:33990)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:33990)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:33990)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:33990)" ""  6 1 1 2147483647 1 "$INSTDIR\gpton.exe" "" "" "Ethereum" 33990 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:33990)" ""  6 2 1 2147483647 1 "$INSTDIR\gpton.exe" "" "" "Ethereum" "" 33990 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:33990)" "" 17 2 1 2147483647 1 "$INSTDIR\gpton.exe" "" "" "Ethereum" "" 33990 "" ""
