...
import (
	...
	"github.com/ptonchain/go-ptonchain/common/mclock"
	...
	"github.com/ptonchain/go-ptonchain/light"
	...
	"github.com/ptonchain/go-ptonchain/trie"
)
...
func (pm *ProtocolManager) Stop() {
	...
	log.Info("Light ptonchain protocol stopped")
}
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	p.Log().Debug("Light ptonchain peer connected", "name", p.Name())
	...
	if err := pm.peers.Register(p); err != nil {
		p.Log().Error("Light ptonchain peer registration failed", "err", err)
		return err
	}
	defer func() {
