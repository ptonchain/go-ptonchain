...
import (
	...
	"github.com/ptonchain/go-ptonchain/accounts/abi/bind"
	"github.com/ptonchain/go-ptonchain/common"
	"github.com/ptonchain/go-ptonchain/contracts/chequebook"
	"github.com/ptonchain/go-ptonchain/contracts/ens"
	"github.com/ptonchain/go-ptonchain/ethclient"
	"github.com/ptonchain/go-ptonchain/metrics"
	"github.com/ptonchain/go-ptonchain/p2p"
	"github.com/ptonchain/go-ptonchain/p2p/discover"
	"github.com/ptonchain/go-ptonchain/p2p/protocols"
	"github.com/ptonchain/go-ptonchain/params"
	"github.com/ptonchain/go-ptonchain/rpc"
	"github.com/ptonchain/go-ptonchain/swarm/api"
	httpapi "github.com/ptonchain/go-ptonchain/swarm/api/http"
	"github.com/ptonchain/go-ptonchain/swarm/fuse"
	"github.com/ptonchain/go-ptonchain/swarm/log"
	"github.com/ptonchain/go-ptonchain/swarm/network"
	"github.com/ptonchain/go-ptonchain/swarm/network/stream"
	"github.com/ptonchain/go-ptonchain/swarm/pss"
	"github.com/ptonchain/go-ptonchain/swarm/state"
	"github.com/ptonchain/go-ptonchain/swarm/storage"
	"github.com/ptonchain/go-ptonchain/swarm/storage/mock"
	"github.com/ptonchain/go-ptonchain/swarm/storage/mru"
	"github.com/ptonchain/go-ptonchain/swarm/tracing"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	addr := &network.BzzAddr{
		...
		UAddr: []byte(discover.NewNode(nodeID, net.IP{127, 0, 0, 1}, 33990, 33990).String()),
	}
